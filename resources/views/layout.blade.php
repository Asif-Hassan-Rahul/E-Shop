...
.paymentWrap .paymentBtnGroup .paymentMethod .method.visa {
    background-image: url("https://image.freepik.com/free-vector/brown-leather-wallet-with-lots-money_68708-304.jpg");
}

.paymentWrap .paymentBtnGroup .paymentMethod .method.master-card {
    background-image: url("https://wicnews.com/wp-content/uploads/2019/02/mastercard__logo_140815.jpg");
}

.paymentWrap .paymentBtnGroup .paymentMethod .method.amex {
    background-image: url("https://thefinancialexpress.com.bd/public/uploads/1533122778.png");
}

.paymentWrap .paymentBtnGroup .paymentMethod .method.vishwa {
    background-image: url("https://fitsmallbusiness.com/wp-content/uploads/2017/11/Payza-logo.png");
}
            ...
            <div class="col-sm-6">
                <div class="contactinfo">
                    <ul class="nav nav-pills">
                        <li><a href="#"><i class="fa fa-phone"></i> +8801827116341</a></li>
            ...
            <div class="col-sm-6">
                <div class="social-icons pull-right">
                    <ul class="nav navbar-nav">
                        <li><a href="https://www.facebook.com/ahr3665" target="_blank"><i class="fa fa-facebook"></i></a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="logo pull-left">
                    <a href="/"><img src="{{URL::to('frontend/images/home/logo1.png')}}" alt="" /></a>
                </div>
                ...
                <div class="shop-menu pull-right">
                    <ul class="nav navbar-nav">
                      ...
                      <?php if($customer_id != NULL){ ?>
                            <li><a href="{{URL::to('/customer_logout/'.$customer_id)}}"><i class="fa fa-lock"></i> Logout</a></li>
                      <?php }
                        else{ ?>
            ...
            <div class="col-sm-9">
                ...
                <div class="mainmenu pull-left">
                    <ul class="nav navbar-nav collapse navbar-collapse">
                        ...
                        <li><a href="/all_shops" class="">All Shops</a></li>
                        {{-- <li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                            ...
                            $customer_id = Session::get('customer_id');
                                ?>
                            <?php if($customer_id != NULL){ ?>
                            <li><a href="{{URL::to('/checkout')}}"><i class=""></i> Checkout</a></li>
                        ...
                        <li class="dropdown"><a href="#">All Category<i class="fa fa-angle-down"></i></a>
                            <ul role="menu" class="sub-menu">
                                <?php
                                ...
                                <li><a href="{{URL::to('/product_by_category/'.$key->category_id)}}">{{$key->category_name}}</a></li>
                                <?php
                                }
                                ?>
                            </ul>
