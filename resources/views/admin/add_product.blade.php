				...
				<form class="form-horizontal" action="{{ url('/save-product') }}" method="POST" enctype="multipart/form-data">
				  ...
				  <fieldset>
					  ...
					  <div class="control-group">
						...
						<div class="controls">
						  <select id="selectError3" name="manufacture_id">
							...
							<option value="{{ $key->manufacture_id }}">{{$key->manufacture_name}}</option>
							<?php
                        	}
                        	?>
						  </select>
					...
					<div class="control-group hidden-phone">
					  <label class="control-label" for="textarea2">Product Short Desctription</label>
					  <div class="controls">
						<textarea class="form-control" name="product_short_description" rows="3" required=""></textarea>
					  </div>
					</div>

					<div class="control-group hidden-phone">
					  <label class="control-label" for="textarea2">Product Long Desctription</label>
					  <div class="controls">
						<textarea class="form-control" name="product_long_description" rows="3" required=""></textarea>
					  </div>
					</div>
