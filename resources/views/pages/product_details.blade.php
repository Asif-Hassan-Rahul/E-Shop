...
<div class="product-details"><!--product-details-->
	...
	<div class="col-sm-9">
		<div class="product-information"><!--/product-information-->
			...
			<span>
				<span>BDT {{$product_by_details->product_price}}</span>
...
<div class="category-tab shop-details-tab" style="background-color: lightgrey"><!--category-tab-->
	<div class="col-sm-12">
	...
	<div class="tab-content">
		<div class="tab-pane fade" id="details" >
			...
			<p>Description: {{$product_by_details->product_long_description}}</p>
